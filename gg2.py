...
v=3000      #liczba węzłów
# e=8000 #liczba krawędzi
# edges=create_edges(v,e)# graf losowy
#g = ig.Graph(v, edges)
# g = ig.Graph.Barabasi(v,3)
# g.write_gml("graf_3000_1.gml")
g=ig.Graph.Read_GML("graf_3000_1.gml")
...
def petla(g,df,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,k):
    ...
    for i in p_zakazenia:
        ...
        print(i)
    df.to_excel(f"graf_3000_1_{k}.xlsx", index=False)
...
df1 = pd.DataFrame(columns=["krok","c_zdrowienie","c_izolacja","p_zakazenia","p_izolacji","Zakazeni","Zdrowi","izolacja","r_izolacji","czas_izolacji"])
df2 = pd.DataFrame(columns=["krok","c_zdrowienie","c_izolacja","p_zakazenia","p_izolacji","Zakazeni","Zdrowi","izolacja","r_izolacji","czas_izolacji"])
df3 = pd.DataFrame(columns=["krok","c_zdrowienie","c_izolacja","p_zakazenia","p_izolacji","Zakazeni","Zdrowi","izolacja","r_izolacji","czas_izolacji"])
df4 = pd.DataFrame(columns=["krok","c_zdrowienie","c_izolacja","p_zakazenia","p_izolacji","Zakazeni","Zdrowi","izolacja","r_izolacji","czas_izolacji"])
t1=threading.Thread(target=petla,args=(g,df,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,0))
t2=threading.Thread(target=petla,args=(g,df1,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,1))
t3=threading.Thread(target=petla,args=(g,df2,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,2))
t4=threading.Thread(target=petla,args=(g,df3,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,3))
t5=threading.Thread(target=petla,args=(g,df4,p_zakazenia,czas_izolacji,p_izolacji,osoby_zarazone,4))
